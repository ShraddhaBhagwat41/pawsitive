...
public class AddStaffActivity extends AppCompatActivity {
    ...
    private Spinner spStaffRole;
    private Switch swStaffStatus;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spStaffRole = findViewById(R.id.spStaffRole);
        swStaffStatus = findViewById(R.id.swStaffStatus);
        ...
        spStaffRole.setAdapter(adapter);
    ...
    private void addStaff() {
        ...
        String role = spStaffRole.getSelectedItem().toString();
        boolean isActive = swStaffStatus.isChecked();
        ...
        networkManager.addStaff(email, password, name, phone, role, isActive, new NetworkManager.ApiCallback<ApiService.BasicResponse>() {
            @Override
