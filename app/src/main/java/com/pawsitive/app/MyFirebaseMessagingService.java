...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private void sendRegistrationToServer(String token) {
        ...
        if(uid != null) {
            ...
            // Example: Assumes ngos or users
            db.collection("users").document(uid).update(data)
                .addOnSuccessListener(aVoid -> Log.d(TAG, "Token saved to user profile"))
                .addOnFailureListener(e -> {
                    // Try ngo_profiles as fallback
                    db.collection("ngo_profiles").document(uid).update(data);
                });
        }
    }

    private void sendNotification(String title, String messageBody) {
        Intent intent = new Intent(this, HomeActivity.class); // Adjust to MapActivity or Incident
